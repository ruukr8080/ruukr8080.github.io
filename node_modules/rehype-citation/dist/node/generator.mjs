...
const rehypeCitationGenerator = Cite => {
  return (options = {}) => {
    return async (tree, file) => {
      var _file$data, _file$data2, _file$data3, _file$data4, _options$inlineBibCla;
      /** @type {string[]} */
      let bibtexFile = [];
      const inputCiteformat = /** @type {string} */ // @ts-ignore
      options.csl || (file == null || (_file$data = file.data) == null || (_file$data = _file$data.matter) == null ? void 0 : _file$data.csl) || (file == null || (_file$data2 = file.data) == null || (_file$data2 = _file$data2.frontmatter) == null ? void 0 : _file$data2.csl) || defaultCiteFormat;
      const noCite = /**  @type {string[] | false} */ // @ts-ignore
      options.noCite || (file == null || (_file$data3 = file.data) == null || (_file$data3 = _file$data3.matter) == null ? void 0 : _file$data3.noCite) || (file == null || (_file$data4 = file.data) == null || (_file$data4 = _file$data4.frontmatter) == null ? void 0 : _file$data4.noCite) || false;
